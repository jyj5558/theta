...
```{r}
rm(list = ls())
setwd("C:/Users/jyj55/OneDrive - purdue.edu/DeWoody_Lab/Dissertation/Theta project/Manuscript/")
data1 <- read_excel("Supplementary Data 2.xlsx")
...
#skewness = 3.67, kurtosis = 14.65 -> try transformation
...
#skewness = -2.37, kurtosis = 7.16 -> forgo log_td
...
#skewness = 6.36, kurtosis = 43.87 -> try transformation
...
#IUCN full category PGLS model - log_het
IUCNcat.pgls <- pgls(log_het ~ IUCN_category + Dim.1 + Dim.2 + Dim.3 + Dim.4 - 1,
...
tiff("Supplementary Figure 15.tif", units="px", width=2100, height=1500, res=300)
ggplot(aes(y=log_het, x=IUCN_category, label=IUCN_category, color=IUCN_category), data = comp_data1$data) + 
  geom_boxplot() +
  geom_jitter(width = 0.05, alpha = 0.25) + 
  theme_classic(base_size=16) + 
  theme(axis.ticks.x=element_blank(), plot.title=element_text(hjust=0.5)) +
  theme(legend.position = "none") +
  labs(y = "Heterozygosity", x="IUCN category") + 
  scale_color_brewer(palette = "Dark2", breaks=iucn, name = "IUCN category") +
  geom_hline(yintercept = mean(comp_data1$data$log_het), linetype = 2) +
...
#IUCN binary category PGLS model - log_het
IUCNb.pgls <- pgls(log_het ~ IUCN.b + Dim.1 + Dim.2 + Dim.3 + Dim.4 - 1,
data = comp_data1, lambda = "ML")
summary(IUCNb.pgls)
anova(IUCNb.pgls)
...
tiff("Figure 2.tif", units="px", width=2100, height=1500, res=300)
ggplot(aes(y=log_het, x=IUCN.b, label=IUCN.b, color=IUCN.b), data = comp_data1$data) + 
  geom_boxplot() +
  geom_jitter(width = 0.05, alpha = 0.25) + 
  theme_classic(base_size=16) + 
  theme(axis.ticks.x=element_blank(), plot.title=element_text(hjust=0.5)) +
  theme(legend.position = "none") +
  labs(y = "Heterozygosity", x="IUCN category") + 
  scale_color_brewer(palette = "Dark2", breaks=iucn.b, name = "IUCN binary category") +
  geom_hline(yintercept = mean(comp_data1$data$log_het), linetype = 2) +
...
tiff("Supplementary Figure 16.tif", units="px", width=2100, height=1500, res=300)
ggplot(aes(y=asin_f100, x=IUCN_category, label=IUCN_category, color=IUCN_category), data = comp_data1$data[!is.na(comp_data1$data$asin_f100),]) + 
  ...
  theme(axis.ticks.x=element_blank(), plot.title=element_text(hjust=0.5)) +
  theme(legend.position = "none") +
  labs(y = "F(ROH > 100kb)", x="IUCN category") + 
  scale_color_brewer(palette = "Dark2", breaks=iucn, name = "IUCN category") +
...
tiff("Supplementary Figure 17.tif", units="px", width=2100, height=1500, res=300)
ggplot(aes(y=asin_f100, x=IUCN.b, label=IUCN.b, color=IUCN.b), data = comp_data1$data[!is.na(comp_data1$data$asin_f100),]) + 
  ...
  theme(axis.ticks.x=element_blank(), plot.title=element_text(hjust=0.5)) +
  theme(legend.position = "none") +
  labs(y = "F(ROH > 1mb)", x="IUCN category") + 
  scale_color_brewer(palette = "Dark2", breaks=iucn.b, name = "IUCN binary category") +
  geom_hline(yintercept = mean(comp_data1$data[!is.na(comp_data1$data$asin_f100),]$asin_f100), linetype = 2) +
...
```{r}
#Population trend PGLS model - log_het
trend.pgls <- pgls(log_het ~ population_trend + Dim.1 + Dim.2 + Dim.3 + Dim.4 - 1,
data = comp_data1, lambda = "ML")
summary(trend.pgls)
anova(trend.pgls)
...
tiff("Supplementary Figure 18.tif", units="px", width=2100, height=1500, res=300)
ggplot(aes(y=log_het, x=population_trend, label=population_trend, color=population_trend), data = comp_data1$data[!is.na(comp_data1$data$population_trend),]) + 
  geom_boxplot() +
  geom_jitter(width = 0.05, alpha = 0.25) + 
  theme_classic(base_size=16) + 
  theme(axis.ticks.x=element_blank(), plot.title=element_text(hjust=0.5)) +
  theme(legend.position = "none") +
  labs(y = "Heterozygosity", x="Population trend") + 
  scale_color_brewer(palette = "Dark2", breaks=pop_trend, name = "Population trend") +
  geom_hline(yintercept = mean(comp_data1$data[!is.na(comp_data1$data$log_het),]$log_het), linetype = 2) +
  #stat_compare_means(method = "anova", label.x = "Non-Threatened", label.y = 0.70) + 
...
tiff("Supplementary Figure 19.tif", units="px", width=2100, height=1500, res=300)
ggplot(aes(y=asin_f100, x=population_trend, label=population_trend, color=population_trend), data = comp_data1$data[!is.na(comp_data1$data$population_trend),]) + 
  ...
  theme(axis.ticks.x=element_blank(), plot.title=element_text(hjust=0.5)) +
  theme(legend.position = "none") +
  labs(y = "F(ROH > 100kb)", x="Population trend") + 
  scale_color_brewer(palette = "Dark2", breaks=pop_trend, name = "Population trend") +
  geom_hline(yintercept = mean(comp_data1$data[!is.na(comp_data1$data$asin_f100),]$asin_f100), linetype = 2) +
  #stat_compare_means(method = "anova", label.x = "Non-Threatened", label.y = 0.70) + 
...
#Geographic range PGLS model - log_het
range.pgls <- pgls(log_het ~ log_range + Dim.1 + Dim.2 + Dim.3 + Dim.4 - 1,
data = comp_data1, lambda = "ML")
summary(range.pgls)
anova(range.pgls)
...
tiff("Figure 3.tif", units="px", width=2100, height=1500, res=300)
ggplot(aes(y=asin_f1000, x=log_range), data = comp_data1$data[!is.na(comp_data1$data$asin_f1000),]) + 
  geom_smooth(method = "lm", se=TRUE) +
  geom_point() + 
  theme_classic(base_size=16) + 
  theme(axis.ticks.x=element_blank(), plot.title=element_text(hjust=0.5)) +
  labs(y = "F(ROH > 1mb)", x="Geographic range")
  #guides(color = guide_legend(title = "F(ROH > 1mb)"))
  

#model comparison
AIC(IUCNcat.pgls, IUCNb.pgls, IUCNcatF100.pgls, IUCNbF100.pgls, trend.pgls, trendF100.pgls)
```
...
#log_het PGLS model - IUCNcat
Hetcat.pgls <- pgls(IUCNcat_numeric ~ log_het + Dim.1 + Dim.2 + Dim.3 + Dim.4 - 1,
data = comp_data1, lambda = "ML")
summary(Hetcat.pgls)
anova(Hetcat.pgls)
anova_stats(Hetcat.pgls)

ggplot(aes(y=IUCNcat_numeric, x=log_het), data = comp_data1$data[!is.na(comp_data1$data$log_het),]) + 
  geom_smooth(method = "lm", se=TRUE) +
  geom_point() + 
  theme_classic(base_size=16) + 
  theme(axis.ticks.x=element_blank(), plot.title=element_text(hjust=0.5)) +
  labs(y = "IUCN full category", x="Heterozygosity")
  #guides(color = guide_legend(title = "F(ROH > 1mb)"))

#log_het PGLS model - IUCNb
Hetb.pgls <- pgls(IUCNb_numeric ~ log_het + Dim.1 + Dim.2 + Dim.3 + Dim.4 - 1,
data = comp_data1, lambda = "ML")
summary(Hetb.pgls)
anova(Hetb.pgls)
anova_stats(Hetb.pgls)

ggplot(aes(y=IUCNb_numeric, x=log_het), data = comp_data1$data[!is.na(comp_data1$data$log_het),]) + 
  geom_smooth(method = "lm", se=TRUE) +
  geom_point() + 
  theme_classic(base_size=16) + 
  theme(axis.ticks.x=element_blank(), plot.title=element_text(hjust=0.5)) +
  labs(y = "IUCN binary category", x="Heterozygosity")
...
tiff("Supplementary Figure 23.tif", units="px", width=2100, height=1500, res=300)
ggplot(data=mod_res, aes(x=IUCN_category, y=genetic_status)) + 
  ...
  geom_abline(slope=1, col='blue', size=1)
dev.off()
```